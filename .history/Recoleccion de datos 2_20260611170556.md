...
# Preguntas con sus respectivos factores y Betas
...
Datos Personales
Fecha de nacimiento (Fecha, si no logramos formato fecha, campos día, mes, año)
...
[SI] 	¿Qué carrera/s cursaste? (X = 0.3) 
[NO] 	(X = 0)
...
Por cada materia del estudiante (Dinámico, según cantidad de materias rendidas cantidad a desplegar, sino se logra en la implementación se optara por hacerlo fijo).
Nota de la materia
Estado finalizado (Aprobado/Habilitado/Desaprobado)
[DESAPROBADO] Explique por qué considera que desaprobó (Cuadro de texto)
Opinión sobre la materia y los docentes (opcional) (Cuadro de texto)
¿Abandonó alguna materia? (Si / No) (β = 2)
[SI] ¿Cuántas y por qué? (Depende de cuantas abandono el valor de X)
